...
| Requirement ID | Requirement Description | Minimum (Not Failure) | Target Measurement | Feature Satisfied | Stretch Goal? (Y/N) |
|---|---|---|---|---|---|
...
| TR-05 | Rover shall measure the ambient temperature | 土 5 ℃ | 土 2 ℃ | Sensor | Yes, be able to convert C to F |
| TR-06 | Rover shall send sensor data to the controller screen and get control information back | Inputs make the rover move/get sensor data | Low Latency / Clean data and graphs | Communication | Yes, Store data in a .csv convertible data bank |
